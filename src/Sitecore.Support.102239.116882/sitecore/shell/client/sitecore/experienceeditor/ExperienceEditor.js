  ...
  experienceEditor.Web = {
    ...
    replaceCEParameter: function (url, value) {
      ...
      postServerRequest: function (requestType, commandContext, handler, async) {
          ...
          //Issue 116882 fix start
          if(commandContext.value!=null && commandContext.value.includes("%22") && requestType.toString()==="ExperienceEditor.Insert.ValidateNewName")
          {
              commandContext.value="%3C"
          }
          try{
              jQuery.ajax({
              ...
              console.log("Sitecore Support Issue 116882 logging. Message: "+ message);
              console.log("Encoded value: "+ commandContext.value);
          }
          //Issue 116882 fix end
      }
  };
